...
def launch_nodes_withconfig(context, *args, **kwargs):
    ...
    # launch configuration:common
    namespace = LaunchConfiguration("namespace")
    use_sim_time = LaunchConfiguration("use_sim_time")
    autostart = LaunchConfiguration("autostart")
    use_respawn = LaunchConfiguration("use_respawn")
    # Launch configuration:mapf_centralagent
    ...
    mapf_centralagent_param_file = LaunchConfiguration("mapf_centralagent_param_file")
    # Launch configuration:navigation
    ...
    actions = [
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(launch_dir, "mapf_centralagent.launch.py")),
            launch_arguments={
                "namespace": namespace,
                "map": map_yaml_file,
                "use_sim_time": use_sim_time,
                "autostart": autostart,
                "params_file": mapf_centralagent_param_file,
                "use_respawn": use_respawn,
                "launch_mapserver": launch_mapserver,
                "launch_plannerserver": launch_plannerserver,
            }.items(),
        ),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(launch_dir, "mapf_navigation.launch.py")),
            launch_arguments={
                "namespace": namespace,
                "use_sim_time": use_sim_time,
                "autostart": autostart,
...
def generate_launch_description():
    ...
    declare_launchplannerserver_cmd = DeclareLaunchArgument(
    ...
    declare_mapfparams_file_cmd = DeclareLaunchArgument(
        "mapf_centralagent_param_file",
    ...
    ld.add_action(declare_mapfparams_file_cmd)
    ld.add_action(declare_launchplannerserver_cmd)
