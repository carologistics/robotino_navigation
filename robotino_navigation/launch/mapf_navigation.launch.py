    ...
    load_nodes = GroupAction(
        actions=[
            ...
            Node(
                ...
                + [
                    (
                        "/" + launch_configuration["namespace"] + "/global_costmap/costmap_raw",
                        "/global_costmap/costmap_raw",
                    ),
                    (
                        "/" + launch_configuration["namespace"] + "/global_costmap/costmap_raw_updates",
                        "/global_costmap/costmap_raw_updates",
                    ),
                    (
                        "/" + launch_configuration["namespace"] + "/global_costmap/published_footprint",
            ...
            Node(
                ...
                + [
                    (
                        "/" + launch_configuration["namespace"] + "/global_costmap/clear_entirely_global_costmap",
